...
<%}}%>                             </li> 
                            <div class="tall">
                                ...
                                if(permitRead || permitModify || permitNotes || isMember){%>
                                    ...
                                    <select class="clear" style="margin: 10% 10%;text-align: center;max-width: 80%;" onchange="navigateTo(this);">
                    ...
                    <div id="tabs-3">
                        <ul id="team" class="ui-helper-reset">
                            <li class="left ui-widget-content ui-corner-tr ui-corner-bl tall">
                                ...
                                %>
                                <br />
                                <div id="inviteUserBtn" class="tpenButton"><span class="ui-icon ui-icon-person right"></span>Invite a New Member</div>
