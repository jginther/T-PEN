        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $("#blogTags").change(function(){
                    ...
                    if (selectedCategory.indexOf("Filter")>0){
                        $(".blogTitle").show();
                        return false;
                    }
            ...
            function blogPosts(url){
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    beforeSend: function(){
                        $("#updates").append("<div id='blogLoad' class='ui-corner-all'>Loading posts from <a href='http://digital-editor.blogspot.com/' target='_blank'>digital-editor.blogspot.com</a> . . .</div>");
                    },
...
//                        console.log(posts);
                        ...
                        for (var i=0;i<posts.entries.length;i++){
                            var tagsLength = posts.entries[i].categories.length;
                            var theseTags = new Array();
                            for (var j=0;j<tagsLength;j++){
                                var thisTag = posts.entries[i].categories[j]
                            ...
                            addResult.push(
                                "<li class='blogTitle ui-state-default ",theseTags.join(" "),"'><a href='",posts.entries[i].link,"' target='_blank'>",
                                posts.entries[i].title.replace("T-PEN","T&#8209;PEN"),
                                "</a></li>");
                            blogContents.push(
                                ...
                                posts.entries[i].author,
                                "</div></div><div class='blogSnippet'>",
                                posts.entries[i].content,
                                "</div></li>");
                        }
                        $("#blogTitles")
