...
/* jQuery Handlers */
    ...
    $('.wBtn.shrink').live({           // shrunk button popovers
        mouseenter: function(){
            ...
            $('#wrapper').append("<div class='btnTitle ui-state-default' style='left:"+pos.left+"px;top:"+(pos.top-22)+"px;'>"+title+"</div>");
        },
        mouseleave: function(){
            $(".btnTitle").remove()
        }
...
var Export = {
    validForm: function(){
        ...
        if (firstFolio <= lastFolio) {
            ...
            alert("The "+Export.ordinal(firstFolio+1)+" page comes after the "+Export.ordinal(lastFolio+1)+" page in this project.\nPlease check your page range.");
            return false;
        }
    },
    ordinal: function(n) {
