...
function encodeXml(string) {
    ...
    if(annotationURI==null)
    {
        ...
        $.ajax({
            type: 'POST',
            url: "proxy?url=http://165.134.241.141:80/Annotation/Annotation"+encodeURIComponent("?"+$.param(params)),
            data: $.param(params),
    ...
    this.update=function()
    {
        ...
        $.ajax({
            type: 'POST',
            url: "proxy?url=http://165.134.241.141:80/Annotation/Annotation",
            data: $.param(params),
            success: function(data) {
            return data;
                },
