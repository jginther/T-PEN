...
<%
if(request.getParameter("uname")!=null && request.getParameter("fname")!=null && request.getParameter("lname")!=null)
    {
...
%>                       <form action="signup.jsp">
                       Email<input class="reginput" type="text" name="uname" <%if(request.getParameter("uname")!=null){out.print("value=\""+request.getParameter("uname")+"\"");}%>/><br/><br/>
                       first name<input class="reginput" type="text" name="fname" <%if(request.getParameter("fname")!=null){out.print("value=\""+request.getParameter("fname")+"\"");}%>/><br/><br/>
                       last name<input class="reginput" type="text" name="lname" <%if(request.getParameter("lname")!=null){out.print("value=\""+request.getParameter("lname")+"\"");}%>/><br/><br/>
