...
public BufferedImage drawLinesOnImage(BufferedImage img)
{
     ...
     for(int i=0;i<linePositions.length;i++)
        {
            ...
            {
                int color=0x0000ff;
                img=imageHelpers.highlightBlock(img,linePositions[i].left, linePositions[i].top,linePositions[i].getHeight(),linePositions[i].getWidth(),color);
            }
            else
            {
                int color=0xff0000;
