...
/**This is a mechanism for controlling the display of tools internal to TPEN in the transcription UI. You can do things like hide the parsing correction
 tool if you have already finished checking parsing for the whole project.*/
public class Tool {
    ...
    public static tools[] getTools(int UID) throws SQLException {
        ...
        try {
            ...
            while (!res.empty()) {
                ...
                if (tmp.compareTo("annotation") == 0) {
                    toret[ctr] = tools.annotation;
                }
                ctr++;
            }
        } finally {
