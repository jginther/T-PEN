...
/**
 *This class handles the process of creating a manuscript and project from a user uploaded zip file full of jpg images.
  */
...
private static File[] removeItem(File[] old,int item)
{
    ...
    /**This function was created as an answer to the stack overflow question http://stackoverflow.com/questions/981578/how-to-unzip-files-recursively-in-java I decided
    ...
    static public void extractFolder(String zipFile) throws ZipException, IOException
{
    ...
    {
        try{
        BufferedImage b=imageHelpers.readAsBufferedImage(f.getAbsolutePath());
        b=imageHelpers.scale(b, 2000);
        imageHelpers.writeImage(b, f.getAbsolutePath());
        }
        catch(Exception e)
        {
