...
/**
 *
 * Update the line position information for a single line of Transcription.
 * Used when they stretch or shrink a line, or add or delete one.
 */
            ...
            if (session.getAttribute("UID") == null) {
                ...
                if (request.getParameter("submitted") != null) {
                    ...
                    if (request.getParameter("new") != null) {
                        ...
                        textdisplay.Transcription t;
                        if(projectID>0)
                        t= new textdisplay.Transcription(thisUser.getUID(),projectID, Integer.parseInt(folioNum), x, y, height, width, true);
                        else
                            t= new textdisplay.Transcription(thisUser.getUID(),0, Integer.parseInt(folioNum), x, y, height, width, false);
