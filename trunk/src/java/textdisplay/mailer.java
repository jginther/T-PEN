...
public class mailer {
    ...
    /**
     * The default mail server used for sending e-mails.
     * @var String
     */
    public static String MAIL_SERVER_DEFAULT = "slumailrelay.slu.edu";
    
    /**
     * The default "from" address used when sending e-mails.
     * @var String
     */
    public static String MAIL_FROM_DEFAULT = "TPEN@t-pen.org";
    ...
    public mailer()
    {
        this.mailServer = mailer.MAIL_SERVER_DEFAULT;
        this.mailFrom = mailer.MAIL_FROM_DEFAULT;
    }
